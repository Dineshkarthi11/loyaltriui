...
import UserCountInput from "./UserCountInputOne"; // Adjust the import as necessary
import DiscountCode from "./DiscountCode"; // Adjust the import as necessary
import TotalAmount from "./TotalAmount"; // Adjust the import as necessary
import ActionButtons from "./ActionButtons"; // Ensure correct import path
import HeaderThird from "./HeaderThird"; // Adjust the import as necessary
import avatarcoupon from "../../../../assets/images/avatarcoupon.png";

function RequestAdditionalUserMore({ closeRequestAdditionalUserMore, setIsModaltwoOpen }) {
  return (
      ...
      <section className="relative z-10 flex flex-col justify-center py-1.5 bg-gradient-to-b from-blue-100 to-white to-[20%] rounded-3xl border border-solid border-zinc-100 max-w-[95%] sm:max-w-[447px] shadow-[0px_31px_60px_rgba(59,55,75,0.1)]">
        <div className="flex overflow-hidden relative flex-col items-center py-5 w-full rounded-2xl max-w-full sm:max-w-[437px] shadow-[0px_10px_15px_rgba(182,181,254,0.19)]">
          ...
          <form className="flex z-0 flex-col mt-4 max-w-full w-full sm:w-[405px]">
            ...
            <DiscountCode />
            <TotalAmount />
            {/* Pass props to ActionButtons */}
            <ActionButtons 
              closeRequestAdditionalUserMore={closeRequestAdditionalUserMore} 
          ...
          <button
            ...
            aria-label="Close"
            onClick={closeRequestAdditionalUserMore} // Close the modal
          >
            <img
              loading="lazy"
