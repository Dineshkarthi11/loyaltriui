...
export default function EditInstallment({
    ...
    const data = [
        ...
        { label: 'Tenure', value: '10 Months', value2: '20 Months' },
    ];
                                    ...
                                    <tr key={index} className='flex items-center justify-between'>
                                        ...
                                        <td>
                                            <div className='flex items-center gap-3 justify-around min-w-[235px]'>
                                                <div>{item.value}</div>
                                                <div className='border-r text-grey !h-[30px] text-center'></div>
